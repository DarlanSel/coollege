...
class TeachersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teacher" do
    assert_difference('Teacher.count') do
      post teachers_url, params: { teacher: { person_id: @teacher.person_id, user_id: @teacher.user_id } }
    end
  ...
  test "should update teacher" do
    patch teacher_url(@teacher), params: { teacher: { person_id: @teacher.person_id, user_id: @teacher.user_id } }
